...
#ifndef PB_MESHTASTIC_CONNECTION_STATUS_PB_H_INCLUDED
#define PB_MESHTASTIC_CONNECTION_STATUS_PB_H_INCLUDED
#include <pb.h>
...
#define MESHTASTIC_CONNECTION_STATUS_PB_H_MAX_SIZE meshtastic_DeviceConnectionStatus_size
