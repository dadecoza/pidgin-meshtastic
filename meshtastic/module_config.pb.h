...
#ifndef PB_MESHTASTIC_MODULE_CONFIG_PB_H_INCLUDED
#define PB_MESHTASTIC_MODULE_CONFIG_PB_H_INCLUDED
#include <pb.h>
...
#define MESHTASTIC_MODULE_CONFIG_PB_H_MAX_SIZE   meshtastic_ModuleConfig_size
