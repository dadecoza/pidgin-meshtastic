...
#ifndef PB_MESHTASTIC_TELEMETRY_PB_H_INCLUDED
#define PB_MESHTASTIC_TELEMETRY_PB_H_INCLUDED
#include <pb.h>
...
#define MESHTASTIC_TELEMETRY_PB_H_MAX_SIZE       meshtastic_Telemetry_size
