...
#ifndef PB_MESHTASTIC_APPONLY_PB_H_INCLUDED
#define PB_MESHTASTIC_APPONLY_PB_H_INCLUDED
#include <pb.h>
...
#define MESHTASTIC_APPONLY_PB_H_MAX_SIZE         meshtastic_ChannelSet_size
