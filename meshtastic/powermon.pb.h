...
#ifndef PB_MESHTASTIC_POWERMON_PB_H_INCLUDED
#define PB_MESHTASTIC_POWERMON_PB_H_INCLUDED
#include <pb.h>
...
#define MESHTASTIC_POWERMON_PB_H_MAX_SIZE        meshtastic_PowerStressMessage_size
