...
#ifndef PB_MESHTASTIC_DEVICEONLY_PB_H_INCLUDED
#define PB_MESHTASTIC_DEVICEONLY_PB_H_INCLUDED
#include <pb.h>
#include <vector>
...
#define MESHTASTIC_DEVICEONLY_PB_H_MAX_SIZE      meshtastic_ChannelFile_size
