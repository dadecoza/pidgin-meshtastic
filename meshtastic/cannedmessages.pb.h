...
#ifndef PB_MESHTASTIC_CANNEDMESSAGES_PB_H_INCLUDED
#define PB_MESHTASTIC_CANNEDMESSAGES_PB_H_INCLUDED
#include <pb.h>
...
#define MESHTASTIC_CANNEDMESSAGES_PB_H_MAX_SIZE  meshtastic_CannedMessageModuleConfig_size
