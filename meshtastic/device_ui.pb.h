...
#ifndef PB_MESHTASTIC_DEVICE_UI_PB_H_INCLUDED
#define PB_MESHTASTIC_DEVICE_UI_PB_H_INCLUDED
#include <pb.h>
...
#define MESHTASTIC_DEVICE_UI_PB_H_MAX_SIZE       meshtastic_DeviceUIConfig_size
