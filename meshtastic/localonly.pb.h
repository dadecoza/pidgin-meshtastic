...
#ifndef PB_MESHTASTIC_LOCALONLY_PB_H_INCLUDED
#define PB_MESHTASTIC_LOCALONLY_PB_H_INCLUDED
#include <pb.h>
#include "config.pb.h"
...
#define MESHTASTIC_LOCALONLY_PB_H_MAX_SIZE       meshtastic_LocalConfig_size
